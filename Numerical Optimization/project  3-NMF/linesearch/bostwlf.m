function Judge = bostwlf(Step, StepSize, Data0, Data, flag)
%BOSTWLF Judge whether Data satisfy the strong Wolfe Criterion and the 
...
%
% Call
% Judge = bostwlf(Step, StepSize, Data0, Data)
% Judge = bostwlf(Step, StepSize, Data0, Data, flag)
%
% Input
